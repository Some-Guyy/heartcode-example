  ...
  return (
    <div className="flex flex-col justify-evenly h-dvh">
      <div className="flex flex-col items-center p-8">
        <p className="font-bold text-5xl py-4">dont do drugs kids</p>
